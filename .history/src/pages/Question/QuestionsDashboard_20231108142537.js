      ...
      <div className="test-instructions-div">
        ...
        <div className="col-md-8 offset-md-2 flexy">
            ...
            <div className="col-md-11  instructions">
              ...
              <div className="flexy mt">
                ...
                {lastQuestion ? (
                  ...
                  <button
                    className="next-btn  offset-md-9 offset-5"
                    onClick={() =>
          ...
          <div className="col-md-4 instructions2">
            {" "}
            <div className="row row-cols-10 row-cols-lg-10 g-2 g-lg-1">
            ...
            {lastQuestion ? (
              <div className="flexy offset-md-2" style={{ marginTop: "120px" }}>
                ...
                <Link to={"/review-page"}>
                  {" "}
                  <button className="review-btn offset-4">Review answer</button>
                </Link>
              </div>
            ) : (
              ""
