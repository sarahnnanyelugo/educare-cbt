...
export const Wallet = () => {
  ...
  return (
    <>
      ...
      <div className={`your-div ${isVisible ? "slide-in" : ""}`}>
        <div className="divss col-md-4">1</div>
        <div className="divss col-md-4">2</div>
        <div className="divss col-md-4">3</div>
        <div className="divss col-md-4">4</div>
        <div className="divss col-md-4">5</div>
      </div>
    </>
  );
};
