      ...
      <div className="col-md-10 offset-md-1">
        ...
        <div className="row row-cols-2 row-cols-lg-3 g-2 g-lg-3">
          ...
          <div className="col">
            <div className="exam-container flexy flexyM">
              {" "}
              <img src={Igcse} alt="logo" className="" width="44px" />
              <h6>IGCSE Exams</h6>
            </div>
          </div>{" "}
          <div className="col">
          ...
          <div className="col">
            <div className="exam-container flexy flexyM">
              {" "}
              <img src={Ielt} alt="logo" className="" width="44px" />
              <h6>IELT Exams</h6>
            </div>
          </div>{" "}
          <div className="col">
            <div className="exam-container flexy flexyM">
              {" "}
              <img src={Olympiad} alt="logo" className="" width="44px" />
          ...
          <div className="col">
            <div className="exam-container flexy flexyM">
              {" "}
              <img src={Sat} alt="logo" className="" width="44px" />
              <h6>SAT Exams</h6>
            </div>
          </div>
          <div className="col">
