      ...
      <div className="landing-div col-md-12 flexy">
        <div className="col-md-4 offset-md-1 mt">
          ...
          <div className="flexy mt2">
            ...
            <img src={Igcse} alt="image" width="30px" className="" />
            <img src={Sat} alt="image" width="45px" className="" />
            <img src={Waec} alt="image" width="54px" className="" />
            <img src={Toefl} alt="image" width="85px" className="" />
            <img src={Jamb} alt="image" width="34px" className="" />
          </div>
