      ...
      <div className="landing-div col-md-12 flexy">
        <div className="col-md-4 offset-md-1 mt">
          ...
          <div className="flexy mt2">
            {" "}
            <img src={Ielt} alt="img" width="54px" height="" className="" />
            <img src={Igcse} alt="img" width="30px" height="" className="" />
            <img src={Sat} alt="img" width="45px" height="" className="" />
            <img src={Waec} alt="img" width="54px" height="" className="" />
            <img src={Toefl} alt="img" width="85px" height="" className="" />
